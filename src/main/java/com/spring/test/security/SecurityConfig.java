...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity
                ...
                .authorizeHttpRequests(ar->ar.requestMatchers("/h2-console/**","/api/v1/invoices/**").permitAll())
                .authorizeHttpRequests(ar->ar.requestMatchers("/api/v1/documents/waiting").hasAuthority("USER"))
